; NOTE: This is a deprecated function, and is not used anywhere in the code, I have left it here just to show how my knowledge progresses through this project
...
print_hex:
    ...
    ret                         ; Return to the place in memory that called the function
